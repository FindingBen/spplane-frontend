        ...
        <div className="flex-1 m-4 bg-gradient-to-br from-[#111827] via-[#1D1A22] to-[#111827] rounded-2xl border border-[#3e6ff4]/20 overflow-hidden flex flex-col">
          ...
          <main className="flex-1 flex items-center justify-center p-4 md:p-8 2xl:p-5 overflow-y-auto overflow-x-hidden">
            <div className="text-center">
              <h1 className="text-2xl md:text-4xl 2xl:text-3xl font-bold text-white mb-6">
                <span className="bg-gradient-to-r from-[#3e6ff4] to-[#60a5fa] bg-clip-text text-transparent">Your Products</span>
              </h1>
              <p className="text-sm md:text-lg 2xl:text-sm text-[#CAC4CF] mb-8 md:mb-12 2xl:mb-8">
                Overview of your SMS products and campaigns
              </p>
              
              {/* Empty State */}
              <div className="bg-[#1f2937] border border-[#3e6ff4]/30 rounded-lg p-6 md:p-12 2xl:p-8 max-w-md mx-auto">
